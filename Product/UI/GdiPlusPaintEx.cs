...
namespace FaceCat {
    ...
    /// Gdi+绘图类
    /// </summary>
    public class GdiPlusPaintEx : FCPaint {
        /// <summary>
        /// 创建绘图类
        /// </summary>
        public GdiPlusPaintEx() {
        }
        ...
        /// 图像缓存
        /// </summary>
        protected Dictionary<String, Bitmap> m_images = new Dictionary<String, Bitmap>();
